...
A háló összerakást saját gépen kezdtük el. Majd a véglegesítését és a tanításokat AWS szerveren, NVIDIA Tesla K80 12GB videokártyán végeztük. A tanításokat Jupyter notebook-ban végeztük, ezek elmentett adatait aztán Tensorboard segítségével elemeztük.
...
\textit{(A grafikonk y tengelyén az MSE hiba értéke x tengelyén az elvégzett epochok száma látható.)}
